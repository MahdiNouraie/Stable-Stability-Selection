# This script generates Figure 3c in the paper.
# The script generates synthetic data with 500 predictors, 50 observations, and 
#a correlation coefficient of 0.8 followed by stable stability selection 
...
ggplot(stability, aes(x = Iteration, y = Stability)) +
  ...
  labs(title = TeX('Stability of Stability Selection ($\\rho = 0.8$, $\\lambda = \\lambda_{stable}$)'), 
