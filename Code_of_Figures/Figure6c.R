...
plot(candidate_set, stab_values, type = "l", col = "blue", lwd = 2, 
     ...
     main = TeX("Stability vs. Regularisation Value vs. MSE ($\\rho = 0.8$)"),
...
# index_of_lambda_pareto
#[1] 30
# since index_of_lambda_stable = index_of_lambda_pareto = 30,
# we show them by a same red dot
...
text(candidate_set[index_of_lambda_pareto], stab_values[index_of_lambda_pareto], "stable, Pareto", pos = 1, col = "red", cex = 1.5) # Add text Pareto
