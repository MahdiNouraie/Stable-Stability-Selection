...
#  [1] latex2exp_0.9.6     glmnet_4.1-8        Matrix_1.6-1.1     
#[4] GEOquery_2.70.0     Biobase_2.62.0      BiocGenerics_0.48.1

#loaded via a namespace (and not attached):
#  [1] limma_3.58.1      dplyr_1.1.4       compiler_4.3.2   
#[4] tidyselect_1.2.1  Rcpp_1.0.13       stringr_1.5.1    
#[7] xml2_1.3.6        tidyr_1.3.1       splines_4.3.2    
#[10] statmod_1.5.0     lattice_0.22-6    readr_2.1.5      
#[13] R6_2.5.1          generics_0.1.3    shape_1.4.6.1    
#[16] iterators_1.0.14  tibble_3.2.1      pillar_1.9.0     
#[19] tzdb_0.4.0        rlang_1.1.4       utf8_1.2.4       
#[22] stringi_1.8.4     cli_3.6.3         magrittr_2.0.3   
#[25] foreach_1.5.2     grid_4.3.2        rstudioapi_0.16.0
#[28] hms_1.1.3         lifecycle_1.0.4   vctrs_0.6.5      
#[31] glue_1.8.0        data.table_1.16.0 codetools_0.2-20 
#[34] survival_3.7-0    fansi_1.0.6       purrr_1.0.2      
...
text(candidate_set[index_of_stable_1sd], stab_values[index_of_stable_1sd], 
     "stable.1sd", pos = 3, col = "red", cex = 1.5) # Add text for stable.1sd
